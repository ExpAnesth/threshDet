...
h1 = uicontrol('Parent',H0, ...
  ...
  'BackgroundColor',[0.8 0.8 0.8], ...
  'Style','text', ...  
  'String','pseudodiff window (& delta t) (ms)', ...
  'Tag','text_pseudoDiffWin');
h1 = uicontrol('Parent',H0, ...
  'Units','normalized', ...
  'HorizontalAlignment','left', ...
  ...
  'Style','edit', ...
  'visible', 'on', ...
  'TooltipString','set to a value larger one sampling interval to get a ''pseudo-differentiated'' trace, ideally suited to the detection of fast transients. Optional second value is delta t.',...
  'Tag','pseudoDiffWin');
